...
///
/// Built on 2026-08-07 at 18:24 UTC
...
class _StringsSettingsGeneralEn {
	...
	late final _StringsSettingsGeneralBrowserRefreshEn browserRefresh = _StringsSettingsGeneralBrowserRefreshEn._(_root);
	late final _StringsSettingsGeneralPriceAlertsEn priceAlerts = _StringsSettingsGeneralPriceAlertsEn._(_root);
...
class _StringsSettingsGeneralPriceAlertsEn {
	_StringsSettingsGeneralPriceAlertsEn._(this._root);
...
class _StringsSettingsGeneralPt implements _StringsSettingsGeneralEn {
	...
	@override late final _StringsSettingsGeneralBrowserRefreshPt browserRefresh = _StringsSettingsGeneralBrowserRefreshPt._(_root);
	@override late final _StringsSettingsGeneralPriceAlertsPt priceAlerts = _StringsSettingsGeneralPriceAlertsPt._(_root);
...
// Path: settings.general.browserRefresh
class _StringsSettingsGeneralBrowserRefreshPt implements _StringsSettingsGeneralBrowserRefreshEn {
...
// Path: settings.general.priceAlerts
class _StringsSettingsGeneralPriceAlertsPt implements _StringsSettingsGeneralPriceAlertsEn {
	_StringsSettingsGeneralPriceAlertsPt._(this._root);
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings.general.browserRefresh.title': return 'Browser refresh';
			case 'settings.general.browserRefresh.description': return 'Many stores block simple requests. Enable a browser in the background to improve automatic price coverage.';
			case 'settings.general.browserRefresh.enabledDescription': return 'Browser refresh may use additional battery and data while checking stores in the background.';
			case 'settings.general.browserRefresh.status': return 'Browser refresh is enabled. Android may still delay background work.';
			case 'settings.general.browserRefresh.fixRestrictions': return 'Fix background restrictions';
			case 'settings.general.priceAlerts.title': return 'Price drop notifications';
			case 'settings.general.priceAlerts.description': return 'Get a phone notification when a tracked product reaches a new best price.';
			case 'settings.general.priceAlerts.enabledDescription': return 'Notifications are enabled for new best prices. Android permission is required.';
			case 'settings.general.priceAlerts.notificationTitle': return ({required Object name}) => '${name} is cheaper';
			case 'settings.general.priceAlerts.notificationBody': return ({required Object current, required Object previous}) => 'Now ${current}, down from ${previous}.';
			case 'settings.general.priceAlerts.permissionDenied': return 'Android notification permission was not granted, so price alerts remain off.';
...
extension on _StringsPt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings.general.browserRefresh.title': return 'Atualização pelo navegador';
			case 'settings.general.browserRefresh.description': return 'Muitas lojas bloqueiam pedidos simples. Ative um navegador em segundo plano para melhorar a cobertura automática de preços.';
			case 'settings.general.browserRefresh.enabledDescription': return 'A atualização pelo navegador pode usar mais bateria e dados ao verificar lojas em segundo plano.';
			case 'settings.general.browserRefresh.status': return 'A atualização pelo navegador está ativa. O Android pode atrasar o trabalho em segundo plano.';
			case 'settings.general.browserRefresh.fixRestrictions': return 'Corrigir restrições de segundo plano';
			case 'settings.general.priceAlerts.title': return 'Notificações de descida de preço';
			case 'settings.general.priceAlerts.description': return 'Receba uma notificação quando um produto atingir um novo melhor preço.';
			case 'settings.general.priceAlerts.enabledDescription': return 'As notificações estão ativas para novos melhores preços. É necessária permissão do Android.';
			case 'settings.general.priceAlerts.notificationTitle': return ({required Object name}) => '${name} está mais barato';
			case 'settings.general.priceAlerts.notificationBody': return ({required Object current, required Object previous}) => 'Agora ${current}, antes ${previous}.';
			case 'settings.general.priceAlerts.permissionDenied': return 'A permissão de notificações do Android não foi concedida, por isso os alertas permanecem desligados.';
