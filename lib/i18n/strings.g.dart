...
class _StringsGithubExplorerEn {
  ...
  String errorPrefix({required Object username}) =>
...
class _StringsGithubExplorerPt implements _StringsGithubExplorerEn {
  ...
  // Translations
  @override
  String get title => 'Explorador do GitHub';
  @override
  String get searchHint => 'Pesquisar um nome de utilizador do GitHub';
  @override
  String get searchButton => 'Pesquisar';
  @override
  String get noResultYet =>
      'Pesquise um nome de utilizador para ver o perfil e os principais repositórios.';
  @override
  String publicRepos({required Object count}) =>
      '${count} repositórios públicos';
  @override
  String followers({required Object count}) => '${count} seguidores';
  @override
  String get topRepos => 'Principais repositórios';
  @override
  String get noRepos => 'Este utilizador não tem repositórios públicos.';
  @override
  String get recentSearches => 'Pesquisas recentes';
  @override
  String get noRecentSearches => 'Ainda não pesquisou nada.';
  @override
  String get favoriteSemantics => 'Alternar favorito';
  @override
  String get settingsTooltip => 'Definições';
  @override
  String get goHomeTooltip => 'Início';
  @override
  String errorPrefix({required Object username}) =>
      'Não foi possível carregar ${username}:';
}
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'githubExplorer.searchHint':
        return 'Search a GitHub username';
      case 'githubExplorer.searchButton':
        return 'Search';
      case 'githubExplorer.noResultYet':
        return 'Search a username to see their profile and top repositories.';
      case 'githubExplorer.publicRepos':
        return ({required Object count}) => '${count} public repos';
      case 'githubExplorer.followers':
        return ({required Object count}) => '${count} followers';
      case 'githubExplorer.topRepos':
        return 'Top repositories';
      case 'githubExplorer.noRepos':
        return 'This user has no public repositories.';
      case 'githubExplorer.recentSearches':
        return 'Recent searches';
      case 'githubExplorer.noRecentSearches':
        return 'Nothing searched yet.';
      case 'githubExplorer.favoriteSemantics':
        return 'Toggle favorite';
      case 'githubExplorer.settingsTooltip':
        return 'Settings';
      case 'githubExplorer.goHomeTooltip':
        return 'Home';
      case 'githubExplorer.errorPrefix':
        return ({required Object username}) => 'Couldn\'t load ${username}:';
      case 'settings.title':
        return 'Settings';
...
extension on _StringsPt {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'githubExplorer.searchHint':
        return 'Pesquisar um nome de utilizador do GitHub';
      case 'githubExplorer.searchButton':
        return 'Pesquisar';
      case 'githubExplorer.noResultYet':
        return 'Pesquise um nome de utilizador para ver o perfil e os principais repositórios.';
      case 'githubExplorer.publicRepos':
        return ({required Object count}) => '${count} repositórios públicos';
      case 'githubExplorer.followers':
        return ({required Object count}) => '${count} seguidores';
      case 'githubExplorer.topRepos':
        return 'Principais repositórios';
      case 'githubExplorer.noRepos':
        return 'Este utilizador não tem repositórios públicos.';
      case 'githubExplorer.recentSearches':
        return 'Pesquisas recentes';
      case 'githubExplorer.noRecentSearches':
        return 'Ainda não pesquisou nada.';
      case 'githubExplorer.favoriteSemantics':
        return 'Alternar favorito';
      case 'githubExplorer.settingsTooltip':
        return 'Definições';
      case 'githubExplorer.goHomeTooltip':
        return 'Início';
      case 'githubExplorer.errorPrefix':
        return ({required Object username}) =>
            'Não foi possível carregar ${username}:';
      case 'settings.title':
        return 'Definições';
      case 'settings.appearance.title':
