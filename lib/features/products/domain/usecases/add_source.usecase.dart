...
/// Attaches a new website source to an existing product.
class AddSourceUseCase
    extends UseCase<Either<Failure, ProductSource>, AddSourceParams> {
  ...
  @override
  Future<Either<Failure, ProductSource>> call(AddSourceParams params) async {
