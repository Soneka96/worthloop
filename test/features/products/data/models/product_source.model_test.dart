...
void main() {
  ...
  group("ProductSourceModel's methods return the correct value", () {
    test('Method fromRow() should return a ProductSourceModel with no offer yet', () {
    ...
    test('Method fromRow() should return a ProductSourceModel with a fetched offer', () {
      final ProductSourceModel model = ProductSourceModel.fromRow(
        ProductSourceRow(
          id: 'source-1',
          productId: 'product-1',
    ...
    test('Method fromEntity() copies every source field with a fetched offer', () {
      final ProductSourceModel model = ProductSourceModel.fromEntity(
        buildProductSource(
      ...
      expect(model.currentPrice, const Money(minorUnits: 49999, currencyCode: 'EUR'));
      expect(model.isAvailable, isTrue);
      expect(model.lastCheckedAt, DateTime(2026, 1, 1, 12));
    });

    test('Method toCompanion() should return the correct companion with no offer yet', () {
    ...
    test('Method toCompanion() should return the correct companion with a fetched offer', () {
      final ProductSourceModel model = buildProductSourceModel(
        createdAt: DateTime(2026, 1, 1),
        currentPrice: const Money(minorUnits: 49999, currencyCode: 'EUR'),
        isAvailable: true,
